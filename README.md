...
To download and extract [a model pre-trained on the Wiki corpus](https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9.tar.gz), run:

    curl -LO https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9.tar.gz
    tar xvzf ucca-bilstm-1.3.9.tar.gz
...
To get [a model](https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9-fr.tar.gz) pre-trained on the [French *20K Leagues* corpus](https://github.com/UniversalConceptualCognitiveAnnotation/UCCA_French-20K)
or [a model](https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9-de.tar.gz) pre-trained on the [German *20K Leagues* corpus](https://github.com/UniversalConceptualCognitiveAnnotation/UCCA_German-20K), run:

    curl -LO https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9-fr.tar.gz
    tar xvzf ucca-bilstm-1.3.9-fr.tar.gz
    curl -LO https://github.com/huji-nlp/tupa/releases/download/v1.3.9/ucca-bilstm-1.3.9-de.tar.gz
    tar xvzf ucca-bilstm-1.3.9-de.tar.gz
