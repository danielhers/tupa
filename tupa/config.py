...
class Config(object, metaclass=Singleton):
    def __init__(self, *args):
        ...
        group.add_argument("--tag-dropout", type=float, default=0.25, help="POS tag dropout parameter")
        group.add_argument("--dep-dropout", type=float, default=0.25, help="dependency label dropout parameter")
        group.add_argument("--node-label-dropout", type=float, default=0.25, help="node label dropout parameter")
