...
def add_param_arguments(argparser=None, arg_default=None):  # arguments with possible format-specific parameter values
    ...
    add(group, "--shape-dim", type=int, default=5, help="dimension for word shape embeddings")
    add(group, "--prefix-dim", type=int, default=3, help="dimension for word prefix embeddings")
    add(group, "--suffix-dim", type=int, default=6, help="dimension for word suffix embeddings")
