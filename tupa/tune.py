...
def main():
    ...
    domains = (
        ...
        ("action_dim",              range(15)),
        ("ner_dim",                 range(15)),
        ("max_node_labels",         get_values_based_on_format(range(1000, 4001))),
        ("min_node_label_count",    range(1, 101)),
        ("layer_dim",               range(50, 1001)),
        ("layers",                  range(1, 3)),
        ("lstm_layer_dim",          range(50, 501, 2)),
        ("lstm_layers",             range(1, 3)),
        ("embedding_layer_dim",     range(50, 501)),
        ("embedding_layers",        range(1, 3)),
        ("output_dim",              range(40, 351)),
        ...
        ("word_dropout_external",   np.arange(.51, step=.01)),
        ("tag_dropout",             np.arange(.31, step=.01)),
        ("dep_dropout",             np.arange(.31, step=.01)),
        ("node_label_dropout",      np.arange(.31, step=.01)),
