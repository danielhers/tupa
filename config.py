...
class Config(object, metaclass=Singleton):
    def __init__(self, *args):
        ...
        group.add_argument("--depdim", type=int, default=10, help="dimension for dependency relation embeddings")
        ...
        group.add_argument("--embeddinglayerdim", type=int, default=500, help="dimension for layers before LSTM")
        group.add_argument("--embeddinglayers", type=int, default=1, help="number of layers before LSTM")
        ...
        group.add_argument("--maxdeps", type=int, default=100, help="maximum number of dep rels to keep embeddings for")
